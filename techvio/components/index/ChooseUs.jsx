...
const ChooseUs = () => {
    return <div className="pmx-4 lg:grid lg:grid-cols-2 lg:place-items-center max-w-screen-lg xl:mx-auto ">
        ...
        <div>
        <div className="text-left grid mx-auto max-w-screen-lg lg:mx-auto xl:mx-auto lg:pr-10  md:ml-16 sm:m-16 xs:m-2 xs:text-sm">
            ...
            <div className="grid gap-3 mt-10 md:grid-cols-2 md:gap-4 md:gap-x-6 ">
