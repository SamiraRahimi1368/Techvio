...
const Hero = () => {
    ...
    >
        <div className=" w-full px-4 lg:grid lg:grid-cols-2 lg:items-top lg:gap-12 lg:px-12 xl:px-20 max-w-screen-xl xl:mx-auto">
            <div >
                <div className=" font-dosis text-slate-100 text-center lg:text-start lg:mx-0 lg:text-5xl sm:text-3xl  font-bold lg:leading-[4rem]  sm:leading-[4rem] sm:leading-[2rem]  lg:mx-0 lg:mt-20 md:mt-24  lg:mx-0 sm:mt-36 sm:ml-10 sm:mr-10">IT Solutions & Business Services Company</div>
                <div className="sm: mt-3 mt-6 mx-0 text-white lg:text-base sm:text-md sm:text-center text-left font-catamaran leading-8  lg:text-start lg:mx-0 md:tex-right text-slate-100 md:text-md sm:text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua, magna aliqua. ipsum is simply dummy text of the printing.</div>
            ...
            <div className="lg:mr-10 aspect-square mt-16 sm:w-4/5 sm:mx-auto md:w-2/3 lg:w-full xl:w-4/5 relative grid lg:grid-cols-6 md:grid-cols-12 gap-4 ">
                <Image
                    fill
